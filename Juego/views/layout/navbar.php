        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-dark">
              <li><a class="dropdown-item" href="index.php?tabla=user&accion=ver&id=1">Estadísticas</a></li>
              <li><a class="dropdown-item" href="index.php?tabla=user&accion=listar">Digievoluciones</a></li>
              <li><a class="dropdown-item" href="index.php?tabla=user&accion=listar">Mi Equipo</a></li>
          </ul>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="index.php" role="button" data-bs-toggle="dropdown" aria-expanded="false">
