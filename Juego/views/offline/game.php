...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    if ($ownPoints>$rivalPoints) {
        ...
        $userController->editarEstadisticas($_SESSION['username']->id, [ "wins" => $_SESSION['username']->wins+1, "loses" => $_SESSION['username']->loses]);
        $resultado="Victoria";
    }elseif ($rivalPoints>$ownPoints) {
        $_SESSION['username']->loses=$_SESSION['username']->loses+1;
        $userController->editarEstadisticas($_SESSION['username']->id, ["wins" => $_SESSION['username']->wins, "loses" =>$_SESSION['username']->loses+1]);
        $resultado="Derrota";
    }
    ...
    <div class="resultado__<?=$resultado?>">
