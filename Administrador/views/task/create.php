...
$projectClient=$projects->ver($_REQUEST["id"] ?? $_SESSION["datos"]["project_id"]);
  ...
  <div id="contenido">
    ...
    <form action="index.php?tabla=task&accion=guardar&evento=crear" method="POST">
      <div class="form-group">
        ...
        <input type="hidden" name="project_id" id="project_id" value="<?= $_REQUEST["id"] ?? $_SESSION["datos"]["project_id"] ?>">
        <input type="text" required class="form-control" id="name" name="name" value="<?= $_SESSION["datos"]["name"] ?? "" ?>" aria-describedby="nombre" placeholder="Introduce Nombre Tarea">
