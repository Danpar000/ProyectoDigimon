...
if ($user == null) {
    ...
    if (isset($_REQUEST["error"])) {
        ...
        if ($user->id == $_SESSION["usuario"]->id) {
            ...
            $_SESSION["usuario"]->name = $user->name;
        }
    }
}
?>
        ...
        ?>
            <form action="index.php?tabla=user&accion=guardar&evento=modificar" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" id="passwordOriginal" name="passwordOriginal" value="<?= $user->password ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="email" name="email" value="<?= $_SESSION["datos"]["email"] ?? $user->email ?>">
